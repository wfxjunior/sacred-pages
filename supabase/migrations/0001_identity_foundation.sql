...
-- Reversible: drop policies/triggers/tables/types in reverse order (no data exists yet).
-- Blueprint: docs/engineering/04-database-blueprint.md §A.
...
-- No update policy: role rows are granted/revoked, never edited.
...
-- ---------------------------------------------------------------------------
-- User preferences (mirrors the shipped localStorage prototype shape so the
-- later sync is lossless: locale, theme, selection color, difficulty, font
-- size, sound, email reminders)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Signup trigger: create profile, default role, default preferences
-- ---------------------------------------------------------------------------
